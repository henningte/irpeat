...
#' for the model and `FALSE` if not (see argument `check_prediction_domain` and
#' section 2.6 in \insertCite{Teickner.2023}{irpeat} for more details). If
...
#'   }
#'   \item{`irp_degree_of_decomposition_1()`, `irp_degree_of_decomposition_2()`,
#'   `irp_degree_of_decomposition_3()`}{These models predict the degree of
#'   decomposition (fraction of initial mass lost) of individual litter types;
#'   for spectra of bulk peat samples and other litter mixtures, post-processing
#'   predictions with a mixing model like provided by [`mmgm`](https://github.com/henningte/mmgm)
#'   \insertCite{Teickner.2025i}{irpeat} is necessary to avoid biases. See \insertCite{Teickner.2026f;textual}{irpeat}
#'   for details.}
#' }
#'
#' @source
...
#'     \insertCite{Teickner.2026f;textual}{irpeat}
#'   }

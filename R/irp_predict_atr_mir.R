...
#'
#' Functions to predict peat properties from attenuated total reflection (ATR)
#' mid-infrared spectra. All functions below have been computed using various
#' organic matter samples. For detailed information on the underlying prediction
#' models, see the details section.
#'
#' @name irp-predict-atr-mir
#'
#' @details

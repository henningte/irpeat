...
#'
#' \code{irp_klason_lignin_2} predicts the Klason lignin content from mid
#' infrared spectra for peat samples using the model
#' \code{\link{model_klason_lignin_2}}. This function may also work for organic matter
...
#'
#' @return \code{x} with a new column "klason_lignin_2" with the predicted
...
#'
#' # make predictions
#' x <- irpeat::irp_klason_lignin_2(x, do_summary = FALSE)
#' }
#' @references
#'   \insertAllCited{}
#' @export
irp_klason_lignin_2 <- function(x,
                                ...,
                                do_summary = FALSE)
{

...
- [`irp_content_klh_hodgkins()`](https://henningte.github.io/irpeat/reference/irp_content_klh_hodgkins.md)
  : Computes contents of Klason lignin and holocellulose of peat from
  mid-infrared spectra
...
- [`irp_hi()`](https://henningte.github.io/irpeat/reference/irp_hi.md) :
  Compute humification indices from mid-infrared spectra

- [`irp_is_in_prediction_domain()`](https://henningte.github.io/irpeat/reference/irp_is_in_prediction_domain.md)
...
- [`irp_as_irp_prediction_domain()`](https://henningte.github.io/irpeat/reference/irp_prediction_domain-conversion.md)
  :

  Converts an object to class `irp_prediction_domain`

- [`new_irp_prediction_domain()`](https://henningte.github.io/irpeat/reference/irp_prediction_domain.md)
  :
...
- [`irpeat_sample_data`](https://henningte.github.io/irpeat/reference/irpeat_sample_data.md)
  : Sample transmission mid-infrared spectra of peat samples

- [`plot(`*`<irp_prediction_domain>`*`)`](https://henningte.github.io/irpeat/reference/plot.irp_prediction_domain.md)
  :

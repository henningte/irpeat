...
> Henning Teickner, Suzanne B. Hodgkins (`r format(Sys.Date(), "%Y")`). _irpeat: Simple Functions to Analyse Mid Infrared Spectra of Peat Samples'_. Accessed `r format(Sys.Date(), "%d %b %Y")`. Online at <https://github.com/henningte/irpeat>.
